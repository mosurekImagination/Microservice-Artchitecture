package net.mosur.ordering.payment.service.messaging.mapper;

import net.mosur.ordering.domain.valueobject.PaymentOrderStatus;
...
import net.mosur.ordering.kafka.order.avro.model.PaymentStatus;
