package net.mosur.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.adapter;

import net.mosur.food.ordering.system.outbox.OutboxStatus;
import net.mosur.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import net.mosur.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import net.mosur.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import net.mosur.food.ordering.system.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import net.mosur.food.ordering.system.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
