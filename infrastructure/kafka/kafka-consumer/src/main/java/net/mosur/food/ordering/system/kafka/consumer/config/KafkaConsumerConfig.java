package net.mosur.food.ordering.system.kafka.consumer.config;

import net.mosur.food.ordering.system.kafka.config.data.KafkaConfigData;
import net.mosur.food.ordering.system.kafka.config.data.KafkaConsumerConfigData;
