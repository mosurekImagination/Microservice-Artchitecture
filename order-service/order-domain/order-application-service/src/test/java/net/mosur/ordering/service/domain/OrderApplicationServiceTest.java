...
import net.mosur.ordering.service.domain.dto.create.OrderItem;
import net.mosur.ordering.service.domain.mapper.OrderDataMapper;
import net.mosur.ordering.service.domain.ports.input.service.OrderApplicationService;
...
public class OrderApplicationServiceTest {
    ...
    public void testCreateOrder() {
        ...
        Assertions.assertNotNull(createOrderResponse.getTrackingOrderId());
    }
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Total price: 250.00 in not equal to Order items total: 200.00!", orderDomainException.getMessage());
    }
