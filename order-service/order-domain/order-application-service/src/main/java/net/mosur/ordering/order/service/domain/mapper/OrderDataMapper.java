package net.mosur.ordering.order.service.domain.mapper;
...
import net.mosur.ordering.order.service.domain.dto.create.OrderAddress;
import net.mosur.ordering.order.service.domain.dto.create.OrderItem;
...
public class OrderDataMapper {
    ...
    private List<net.mosur.ordering.order.service.domain.entity.OrderItem> orderItemsToOrderItemsEntities(List<OrderItem> items) {
        return items.stream().map(orderItem ->
                net.mosur.ordering.order.service.domain.entity.OrderItem.Builder.builder()
