package net.mosur.ordering.order.service.dataaccess.order.adapter;

import net.mosur.ordering.order.service.dataaccess.order.mapper.OrderDataAccessMapper;
import net.mosur.ordering.order.service.dataaccess.order.repository.OrderJpaRepository;
